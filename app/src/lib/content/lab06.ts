...
export const lab06: Lab = {
	...
	steps: [
		...
		},
		{
			...
			gloss: 'music',
			teach:
				'<p><span class="hg">음</span> + <span class="hg">악</span> → <span class="hg">[으막]</span> (eum-ak → [eu-mag]).</p><p>The spelling still writes <span class="hg">음</span>, because that is the word. Speech does not care: the <span class="jamo">ㅁ</span> would rather be an onset than an unreleased stop.</p>'
		},
		{
			type: 'liaison',
			...
			teach:
				'<p><span class="hg">[오시]</span> (o-si), not <span class="hg">[오디]</span> (o-di).</p><p>Isolation had to pick one of seven sounds, so <span class="jamo">ㅅ</span> collapsed to <span class="jamo">ㄷ</span>. The spelling kept <span class="jamo">ㅅ</span> so a following vowel could bring the real letter back. That is the aside from Lab 04, paid off.</p>'
		},
		{
			type: 'liaison',
			...
			gloss: 'in the field',
			teach:
				'<p><span class="hg">[바테]</span> (ba-te). The <span class="jamo">ㅌ</span> comes back as <span class="jamo">ㅌ</span> — aspiration is allowed again once the letter is on top.</p><p><span class="hg">밭이</span> (bat-i) would go further and palatalize to <span class="hg">[바치]</span> (ba-chi). That is a later rule. <span class="jamo">에</span> keeps this card honest.</p>'
		},
		{
			type: 'liaison',
			...
			teach:
				'<p><span class="hg">[부어케]</span> (bu-eo-ke). <span class="jamo">ㅋ</span>, not <span class="jamo">ㄱ</span>.</p><p>Three collapses reversed: <span class="jamo">ㅅ</span>→<span class="jamo">ㄷ</span> undone, <span class="jamo">ㅌ</span>→<span class="jamo">ㄷ</span> undone, <span class="jamo">ㅋ</span>→<span class="jamo">ㄱ</span> undone. Written Korean was telling the truth the whole time.</p>'
		},
		{
			type: 'choice',
			...
			answer: 0,
			teach:
				'<p><strong>Liaison (연음, yeon-eum)</strong>. Korean spelling is morphophonemic: it writes the identity of a piece, not a recording of the sound. Liaison is how speech puts those pieces into pronounceable slots.</p>'
		},
		{
			type: 'liaison',
			...
			teach:
				'<p>Stay. <span class="hg">[강이]</span> (gang-i), not <span class="hg">[가이]</span> (ga-i).</p><p>That <span class="jamo">ㅇ</span> is already a sound — <span class="rom">ng</span>. Move it into the next onset and it becomes the silent placeholder, and the ng vanishes. Same letter, two jobs; only the placeholder is a hole.</p>'
		},
		...
		/* ---- A cluster splits when a vowel follows ---- */
		{
			...
			answer: 0,
			teach:
				'<p>You do not have to throw a letter away when a vowel is waiting to hold it.</p><p>Isolation Rule A/B was "which one, when you can keep only one." When a vowel follows, the second letter jumps and the first stays as batchim.</p>'
		},
		{
			type: 'liaison',
			do: 'Make the split.',
			...
			teach:
				'<p><span class="hg">[일거요]</span> (il-geo-yo). <span class="jamo">ㄹ</span> closes <span class="hg">일</span>; <span class="jamo">ㄱ</span> opens <span class="hg">거</span>.</p><p>Lab 05\'s Rule B still holds before a consonant or a pause. A following <span class="jamo">ㅇ</span> changes the job.</p>'
		},
		{
			type: 'liaison',
			...
			gloss: 'sit (informal)',
			teach:
				'<p><span class="hg">[안자]</span> (an-ja). <span class="jamo">ㄴ</span> stays; <span class="jamo">ㅈ</span> jumps.</p><p>Compare <span class="hg">앉다</span> (anj-da → [an-tta]), where <span class="jamo">ㅈ</span> was thrown away and <span class="hg">다</span> tensed. Same spelling, different neighbor, different spoken form.</p>'
		},

		/* ---- ㅅ moves and becomes ㅆ ---- */
		{
			type: 'choice',
			do: 'When a cluster jumper is ㅅ, it tenses. <span class="hg">없어</span> is…',
			stage: [{ glyph: '없어' }],
			options: ['[업써]', '[업서]', '[업더]', '[언서]'],
			answer: 0,
			miss:
			...
			teach:
				'<p><span class="hg">[업써]</span> (eop-sseo). <span class="jamo">ㅂ</span> stays; <span class="jamo">ㅅ</span> jumps and tenses to <span class="jamo">ㅆ</span>.</p><p>Review will hold this one.</p>'
		},
		{
			type: 'choice',
			...
			answer: 0,
			teach:
				'<p><span class="hg">[조아요]</span> (jo-a-yo) is what you will hear, and it is not liaison. Batchim <span class="jamo">ㅎ</span> before a vowel drops.</p><p>Do not cram it into this rule. Later labs take the rest one at a time.</p>'
		},
		...
		/* ---- Read from the letters alone ---- */
		{
			...
			answer: 0,
			teach:
				'<p><strong>han-guk-eo</strong>, said <span class="hg">[한구거]</span> (han-gu-geo).</p><p>You just read the name of the language you are learning, and you know why it does not sound like the spelling.</p>'
		},
		{
			type: 'read',
			...
			answer: 0,
			teach:
				'<p><strong>bu-eok-e</strong>, said <span class="hg">[부어케]</span> (bu-eo-ke).</p><p>The <span class="jamo">ㅋ</span> you restored, in a phrase you might actually text.</p>'
		},
		{
			type: 'read',
			...
			answer: 0,
			teach:
				'<p><strong>han-geul-eul</strong>, said <span class="hg">[한그를]</span> (han-geu-reul).</p><p>The name of the writing system, as it appears in a real sentence. Liaison is why <span class="hg">을</span> does not sound like a separate "eul" after <span class="hg">글</span>.</p>'
		}
	]
};
