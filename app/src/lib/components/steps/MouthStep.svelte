	...
	>
		...
		<path
			...
			d="M96,28
			   ...
			   C12,122 10,132 22,138
			   C34,142 44,140 50,148
			   C38,150 32,156 40,162
			   C50,166 66,158 78,148
			   ...
			   C344,252 340,272 330,288
			   L372,288 L372,44
			   C320,18 200,12 96,28 Z
			   M36,130
			   C56,114 96,96 148,86
			   C204,76 256,84 286,108
			   C272,116 230,104 176,106
		...
		<ellipse class="nostril" cx="28" cy="132" rx="7" ry="5" transform="rotate(-18 28 132)" />
		...
		<!-- vermillion pads meeting at the labial zone -->
		<path
			class="lip"
			d="M74,138
			   C56,132 40,136 34,144
			   C32,150 44,154 62,150
			   C72,148 78,144 74,138 Z"
		/>
		<path
			class="lip"
			d="M62,150
			   C42,154 28,164 32,176
			   C38,186 56,182 72,168
			   C78,160 74,152 62,150 Z"
		/>

		<!-- one upper and one lower incisor in profile -->
		<path
			class="tooth"
			d="M106,126
			   C109,122 117,122 120,126
			   L122,150
			   C120,157 116,160 112,160
			   C108,160 104,156 104,150 Z"
		/>
		<path
			class="tooth"
			d="M106,178
			   C109,182 117,182 120,178
			   L122,154
			   C120,149 116,146 112,146
			   C108,146 104,150 104,154 Z"
		/>
